      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-8 text-center">
        ...
        <div className="flex items-center justify-center gap-4 pt-2">
          <a
            ...
            className="w-10 h-10 rounded-full bg-white/10 hover:bg-[#E9C168] hover:text-[#1C1C1C] flex items-center justify-center transition duration-300 text-white shadow-sm"
          >
